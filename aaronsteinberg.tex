...
\begin{rSection}{Work Experience}
    ...
    \begin{itemize}[noitemsep]
        ...
        \item Vehicle Security, Secure Boot, Measured Boot, Key Management
    ...
    \begin{itemize}[noitemsep]
            ...
            \item Database Management and Schema Design
            \item Javascript, Microsoft SQL Server, PHP
    \end{itemize}
    ...
    \vspace{-0.65em}
    \begin{itemize}[noitemsep]
            \item Google Workspace Admin for UC Santa Cruz
            \item Developed tool to identify and mitigate external abuse of university cloud storage
            \item Python, GAM
    \end{itemize}
...
\begin{rSection}{Skills}
    {\textbf{Programming Languages:} } C, C++, C\#, Golang, Haskell, Java, Javascript, PHP, Python, SQL
    \\{\textbf{Technologies and Other Skills:} }
    ArgoCD, Bazel, Buildkite, CMake, Cryptography, Distributed Systems, Docker, Embedded Systems, Express, GTest, gRPC, Key Management, Kubernetes, LaTeX, Linux, Make, Measured Boot \& Attestation, Metrics, Node, Operating Systems, Protocol Buffers, RBAC, React, REST APIs, Secure Boot, Spacelift, SSL, Terraform, TLS, Trace 32
\end{rSection}
